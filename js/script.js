...
let createSquare = () => {
    for (i = 0; i < 16 * 16; i++) {
        const content = document.createElement('div');
        content.setAttribute('style', 'margin: 0.1rem; background: #222; width: 4rem; height: 4rem')
        content.classList.add('square')
        container.appendChild(content);
    }
}

container.setAttribute('style', 'display: flex; justify-content:center; flex-direction: column; flex-wrap: wrap')
